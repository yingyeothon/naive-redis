...
function redisSimpleCache(fn, { config, cacheKey, expirationMillis, decode = JSON.parse, encode = JSON.stringify, }) {
    function computeIfAbsent(...args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield work_1.default(config, (connection) => __awaiter(this, void 0, void 0, function* () {
                const maybe = yield get_1.default(connection, key);
                if (maybe !== null) {
                    return decode(maybe);
                }
                const result = yield fn(...args);
                yield set_1.default(connection, key, encode(result), { expirationMillis });
                return result;
            }));
        });
    }
    ...
    function clear(...args) {
        return __awaiter(this, void 0, void 0, function* () {
            yield del_1.default({ config, key: cacheKey(...args) });
        });
    }
    function peek(...args) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield get_2.default({
                config,
                key: cacheKey(...args),
                decode,
            });
